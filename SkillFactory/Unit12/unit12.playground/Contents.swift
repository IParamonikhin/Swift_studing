...
siteShop.userSelectsPurchasesDogGoodsStore(feed: .chappi, toys: nil)
siteShop.userSelectsPurchasesDogGoodsStore(feed: nil, toys: .rope)
siteShop.userSelectsPurchasesDogGoodsStore(feed: .royalcanin, toys: .stick)
